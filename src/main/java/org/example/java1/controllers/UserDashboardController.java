...
public class UserDashboardController {
    ...
    private void handleEditProfile() {
        if (currentUser != null) {
            ...
            org.example.java1.utils.Session.getInstance().setUser(currentUser);

            // Open Edit Profile screen
            javafx.stage.Stage stage = (javafx.stage.Stage) welcomeLabel.getScene().getWindow();
            org.example.java1.utils.SceneManager.switchScene(stage, "/org/example/java1/edit_profile.fxml",
    ...
    private void handleViewProfile() {
        if (currentUser != null) {
            javafx.stage.Stage stage = (javafx.stage.Stage) welcomeLabel.getScene().getWindow();
            org.example.java1.utils.SceneManager.switchScene(stage, "/org/example/java1/view_profile.fxml",
    ...
    private void handleLogout() {
        // Clear the session
        org.example.java1.utils.Session.getInstance().setUser(null);

        // Redirect to login screen
        javafx.stage.Stage stage = (javafx.stage.Stage) welcomeLabel.getScene().getWindow();
        org.example.java1.utils.SceneManager.switchScene(stage, "/org/example/java1/login.fxml", null);
    }
